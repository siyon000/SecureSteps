        ...
        return (
            <div className="max-w-3xl mx-auto px-4 py-8">
                <div className={`rounded-2xl shadow-xl overflow-hidden ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
                    ...
                    <div className="p-6">
                        <div className={`rounded-xl p-8 text-center ${isDark
                            ? 'bg-gray-700'
                            : 'bg-indigo-50'
                            }`}>
                            ...
                            <button
                                ...
                                className="bg-purple-600 text-white py-3 px-6 rounded-xl font-semibold hover:bg-purple-700 transition-all duration-200 transform hover:scale-105"
                            >
                                Try Again
                            </button>
                        </div>
                ...
                <div className="p-6">
                    ...
                    <div className="mt-6 flex justify-between">
                        <button
                            ...
                            className="bg-blue-600 text-white py-3 px-6 rounded-xl font-semibold hover:bg-blue-700 transition-all duration-200 transform hover:scale-105"
                        >
